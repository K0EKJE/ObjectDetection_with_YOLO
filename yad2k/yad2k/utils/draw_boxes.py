...
def draw_boxes(image, boxes, box_classes, class_names, box_confidence, scores=None, verbose = 1):
    ...
    Args:
        ...
        verbose : output nothing if verbose = 0; print scores and boxes if verbose = 1. 
    ...
    for i, c in list(enumerate(box_classes)):
        ...
        if verbose == 1:
            if box_confidence.numpy()[i] < 0.4: 
                print("--"*50)
                print(label, (left, top), (right, bottom), "with object confidence: ", box_confidence.numpy()[i], "\n(will be discarded in improved mode; with minimum object confidence setting to be 0.4)")
                print("--"*50)
            else: 
                print(label, (left, top), (right, bottom), "with object confidence: ", box_confidence.numpy()[i])
